  ...
  <React.Fragment>
   <div className="sidebar-main-section">
    <div className="brand-title d-flex align-items-center">
     <Link to="/dashboard" className="d-flex align-items-center cursor-pointer">
               ...
               <li className="sidebar-link">
                <Link className="" to={`/version?${item.table_prefix}`}>
                 <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                  <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                   <rect x="0" y="0" width="24" height="24"></rect>
                   <path d="M7.5,4 L7.5,19 L16.5,19 L16.5,4 L7.5,4 Z M7.71428571,2 L16.2857143,2 C17.2324881,2 18,2.8954305 18,4 L18,20 C18,21.1045695 17.2324881,22 16.2857143,22 L7.71428571,22 C6.76751186,22 6,21.1045695 6,20 L6,4 C6,2.8954305 6.76751186,2 7.71428571,2 Z" fill="#000000" fillRule="nonzero"></path>
